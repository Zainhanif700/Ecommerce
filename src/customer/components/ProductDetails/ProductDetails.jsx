                    ...
                    <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <form className="mt-10">
                                ...
                                <Button variant='contained' onClick={handleAddToCart} sx={{ px: '2rem', py: '1rem', mt: '2rem', bgcolor: '#9155fd' }}>
                                    Add to Cart
                                </Button>
                            </form>
                        </div>
                            ...
                            <Grid item xs={5}>
                                ...
                                <Box className='mt-5 space-y'>
                                    <Grid container gap={2} alignItems={'center'}>
                                        ...
                                        <Grid item xs={7}>
                                            <LinearProgress sx={{ bgcolor: '#d0d0d0', borderRadius: 4, height: 7 }} variant='determinate' value={60} color='success'></LinearProgress>
                                        </Grid>
                                    </Grid>
                                    ...
                                    <Grid container gap={2} alignItems={'center'}>
                                        ...
                                        <Grid item xs={7}>
                                            <LinearProgress sx={{ bgcolor: '#d0d0d0', borderRadius: 4, height: 7 }} variant='determinate' value={45} color='success'></LinearProgress>
                                        </Grid>
                                    </Grid>
                                    <Grid container gap={2} alignItems={'center'}>
                                        <Grid item xs={2}>
                                        ...
                                        <Grid item xs={7}>
                                            ...
                                            }} variant='determinate' value={35} className='bg-yellow-300'></LinearProgress>
                                        </Grid>
                                    </Grid>
                                    <Grid container gap={2} alignItems={'center'}>
                                        <Grid item xs={2}>
                                        ...
                                        <Grid item xs={7}>
                                            <LinearProgress sx={{ bgcolor: '#d0d0d0', borderRadius: 4, height: 7 }} variant='determinate' value={25} color='warning'></LinearProgress>
                                        </Grid>
                                    </Grid>
                                    <Grid container gap={2} alignItems={'center'}>
                                        <Grid item xs={2}>
                                        ...
                                        <Grid item xs={7}>
                                            <LinearProgress sx={{ bgcolor: '#d0d0d0', borderRadius: 4, height: 7 }} variant='determinate' value={17} color='error'></LinearProgress>
                                        </Grid>
                                    </Grid>
                                </Box>
                            </Grid>
